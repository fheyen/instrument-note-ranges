...
/**
 * Possible notes for each instrument.
 */
export const MIDI_NOTE_RANGES = [
    { type: 'Keys', label: 'Piano', min: 21, max: 108 },
    // Strings
    { type: 'Strings', label: 'Violin', min: 55, max: 103 },
    { type: 'Strings', label: 'Viola', min: 48, max: 91 },
    { type: 'Strings', label: 'Cello', min: 36, max: 76 },
    { type: 'Strings', label: 'Double Bass', min: 28, max: 67 },
    { type: 'Strings', label: 'Bass Guitar (4 string)', min: 28, max: 67 },
    { type: 'Strings', label: 'Bass Guitar (5 string)', min: 23, max: 67 },
    { type: 'Strings', label: 'Acoustic Guitar (6 string)', min: 40, max: 88 },
    { type: 'Strings', label: 'Acoustic Guitar (7 string)', min: 35, max: 88 },
    { type: 'Strings', label: 'Ukulele', min: 60, max: 81 },
    // Brass
    { type: 'Brass', label: 'Tuba', min: 28, max: 58 },
    { type: 'Brass', label: 'Bass Trombone', min: 34, max: 67 },
    { type: 'Brass', label: 'French Horn', min: 34, max: 77 },
    { type: 'Brass', label: 'Trombone', min: 40, max: 72 },
    { type: 'Brass', label: 'Trumpet', min: 55, max: 82 },
    // Woodwinds
    { type: 'Woodwind', label: 'Piccolo', min: 74, max: 102 },
    { type: 'Woodwind', label: 'Flute', min: 60, max: 96 },
    { type: 'Woodwind', label: 'Oboe', min: 58, max: 91 },
    { type: 'Woodwind', label: 'Alto Flute', min: 55, max: 91 },
    { type: 'Woodwind', label: 'Cor Anglais (English Horn)', min: 52, max: 81 },
    { type: 'Woodwind', label: 'Clarinet', min: 50, max: 94 },
    { type: 'Woodwind', label: 'Bass Clarinet', min: 38, max: 77 },
    { type: 'Woodwind', label: 'Bassoon', min: 34, max: 75 },
    { type: 'Woodwind', label: 'Contrabassoon', min: 22, max: 53 },
    { type: 'Woodwind', label: 'Soprano Recorder', min: 72, max: 98 },
    { type: 'Woodwind', label: 'Alto Recorder', min: 65, max: 91 },
    { type: 'Woodwind', label: 'Tenor Recorder', min: 60, max: 86 },
    { type: 'Woodwind', label: 'Bass Recorder', min: 53, max: 79 },
    { type: 'Woodwind', label: 'Baritone Sax', min: 36, max: 69 },
    { type: 'Woodwind', label: 'Tenor Sax', min: 44, max: 76 },
    { type: 'Woodwind', label: 'Alto Sax', min: 49, max: 81 },
    { type: 'Woodwind', label: 'Soprano Sax', min: 56, max: 88 },
    // Tuned Percussion
    { type: 'Tuned percussion', label: 'Glockenspiel', min: 79, max: 108 },
    { type: 'Tuned percussion', label: 'Xylophone', min: 65, max: 108 },
    { type: 'Tuned percussion', label: 'Vibraphone', min: 53, max: 89 },
    { type: 'Tuned percussion', label: 'Marimba', min: 45, max: 96 },
    { type: 'Tuned percussion', label: 'Bass Marimba', min: 33, max: 81 },
    { type: 'Tuned percussion', label: 'Celeste', min: 60, max: 108 },
    { type: 'Tuned percussion', label: 'Tubular Bells', min: 60, max: 77 },
    { type: 'Tuned percussion', label: 'Timpani', min: 40, max: 55 },
    { type: 'Tuned percussion', label: 'Harpsichord', min: 29, max: 89 },
    { type: 'Tuned percussion', label: 'Harp', min: 24, max: 103 }
];
